...
class ComponentFactory:
    ...
    def _create_component_from_template(
        ...
        return WTPComponent(
            ...
            component_name=template.get('description', component_id.replace('_', ' ').title()),
    ...
    def _create_parameter(
        ...
        param_specs = self._get_parameter_specs(measurement_type, template_name, site_config)
        ...
        return Parameter(
            ...
            quality_degradation_chance=param_specs.get('quality_degradation_chance', 0.02)
        )
    
    def _generate_plc_tag(self, tag_counter: Dict[str, int], param_type: ParameterType) -> str:
    ...
    def _get_parameter_specs(
        ...
        specs = {
            MeasurementType.LEVEL: {"unit": "m", "min_value": 0.0, "max_value": 10.0, "precision": 2},
            MeasurementType.FLOW_RATE: {"unit": "m3/h", "min_value": 0.0, "max_value": 100.0, "precision": 1},
            MeasurementType.TURBIDITY: {"unit": "NTU", "min_value": 0.0, "max_value": 100.0, "precision": 2},
            MeasurementType.PH: {"unit": "pH", "min_value": 4.0, "max_value": 12.0, "precision": 2},
            MeasurementType.TEMPERATURE: {"unit": "°C", "min_value": -10.0, "max_value": 50.0, "precision": 1},
            MeasurementType.PRESSURE: {"unit": "bar", "min_value": 0.0, "max_value": 10.0, "precision": 2},
            MeasurementType.DIFFERENTIAL_PRESSURE: {"unit": "mbar", "min_value": 0, "max_value": 500, "precision": 0},
            MeasurementType.CONDUCTIVITY: {"unit": "µS/cm", "min_value": 50, "max_value": 2000, "precision": 0},
            MeasurementType.DISSOLVED_OXYGEN: {"unit": "mg/L", "min_value": 0.0, "max_value": 20.0, "precision": 2},
            MeasurementType.CHLORINE_RESIDUAL: {"unit": "mg/L", "min_value": 0.0, "max_value": 5.0, "precision": 2},
            MeasurementType.ALKALINITY: {"unit": "mg/L", "min_value": 20.0, "max_value": 300.0, "precision": 1},
            MeasurementType.TOC: {"unit": "mg/L", "min_value": 0.0, "max_value": 20.0, "precision": 2},
            MeasurementType.MOTOR_CURRENT: {"unit": "A", "min_value": 0.0, "max_value": 50.0, "precision": 1},
            MeasurementType.MOTOR_TEMPERATURE: {"unit": "°C", "min_value": 15.0, "max_value": 100.0, "precision": 1},
            MeasurementType.VIBRATION: {"unit": "mm/s", "min_value": 0.1, "max_value": 10.0, "precision": 2},
            MeasurementType.POWER_CONSUMPTION: {"unit": "kW", "min_value": 0.0, "max_value": 50.0, "precision": 1},
            MeasurementType.CHEMICAL_TANK_LEVEL: {"unit": "m", "min_value": 0.1, "max_value": 5.0, "precision": 2},
            MeasurementType.CHEMICAL_DOSE_RATE: {"unit": "mg/L", "min_value": 0.0, "max_value": 50.0, "precision": 2},
            MeasurementType.PUMP_SPEED: {"unit": "%", "min_value": 0.0, "max_value": 100.0, "precision": 1},
            MeasurementType.VALVE_POSITION: {"unit": "%", "min_value": 0.0, "max_value": 100.0, "precision": 1},
            MeasurementType.RUN_STATUS: {"unit": "bool", "min_value": 0, "max_value": 1, "precision": 0},
            MeasurementType.ALARM_STATUS: {"unit": "bool", "min_value": 0, "max_value": 1, "precision": 0},
            MeasurementType.MAINTENANCE_MODE: {"unit": "bool", "min_value": 0, "max_value": 1, "precision": 0},
        }
        
        # Adjust ranges based on template type and site configuration
        base_spec = specs.get(measurement_type, {"unit": "unit", "min_value": 0, "max_value": 100, "precision": 2})
        
        # Context-specific adjustments
        if template_name == "intake_pump" and measurement_type == MeasurementType.FLOW_RATE:
            # Intake pumps typically have higher flow rates
            base_spec["max_value"] = site_config.get('parameters', {}).get('normal_flow_rate', 50) * 1.5
        
        elif template_name == "finished_water_pump" and measurement_type == MeasurementType.PRESSURE:
    ...
    def _should_include_optional(self, sensor_type: str, template_name: str) -> bool:
        ...
        advanced_sensors = ['dissolved_oxygen', 'toc', 'chlorophyll_a', 'streaming_current']
