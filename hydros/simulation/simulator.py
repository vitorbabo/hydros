...
class SimulationEngine:
    ...
    def initialize_simulation(self, config_file: Optional[str] = None):
        """Initialize simulation with plant configuration"""
        try:
            if config_file:
                self.plant_model.load_plant_configuration(config_file)

            # Create component factory with the config file
            from core.component_factory import ComponentFactory

            self.component_factory = ComponentFactory(config_file)
